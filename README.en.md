...
fpms-saas-template is a fengwu saas2.0 template. Using the latest `vue3`, `vite2`, `TypeScript` and other mainstream technology development, the out-of-the-box middle and back-end front-end solutions can also be used for learning reference.
...
```bash
git clone ssh://git@gitlab.aiforward.cn:2222/fe/fpms-saas-template.git
```
